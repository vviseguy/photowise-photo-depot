const projects = [
    { id: 1, title: "Project Alpha", size: "20 MB", files: 10, lastAccessed: "2024-12-20" },
    { id: 2, title: "Project Beta", size: "15 MB", files: 8, lastAccessed: "2024-12-18" },
    { id: 3, title: "Project Gamma", size: "50 MB", files: 25, lastAccessed: "2024-12-15" },
  ];
  
  const dummyPhotos = Array.from({ length: 20 }, (_, i) => `https://picsum.photos/150?random=${i}`);
  ...
  function renderProjects() {
    ...
    projects.forEach((project) => {
      ...
      label.setAttribute("for", `checkbox-${project.id}`);
      ...
      projectDiv.addEventListener("mousedown", (e) => {
        ...
        projectDiv.addEventListener("mouseup", () => clearTimeout(timer), {
          once: true,
        });
      });

      projectDiv.addEventListener("click", (e) => {
        if (!isSelectable && e.target !== checkbox) {
